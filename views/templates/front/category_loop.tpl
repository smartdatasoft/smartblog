        ...
        <div class="sdsarticleHeader">
            ...
            <span>{l s='Posted by' mod='smartblog'} 
                ...
                <span itemprop="dateCreated">
                    {Tools::displayDate($post.created, null, $smartshowtime)}
                </span>
                ...
                <span class="comment"> &nbsp;<i class="icon icon-comments"></i>&nbsp; 
                    <a title="{$post.totalcomment} Comments" href="{smartblog::GetSmartBlogLink('smartblog_post',$options)}#articleComments">{l s=' Comments' mod='smartblog'} ({$post.totalcomment})</a>
                </span>
                {if $smartshowviewed ==1}&nbsp; <i class="icon icon-eye-open"></i>
