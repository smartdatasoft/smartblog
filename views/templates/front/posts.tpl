   ...
   <div itemtype="#" itemscope="" id="sdsblogArticle" class="blog-post">
      ...
      <div class="post-info">
         {assign var="catOptions" value=null}
                     ...
                     <span>
               {if $smartshowauthor ==1}{l s='Posted by ' mod='smartblog'} <i class="icon icon-user"></i>&nbsp;<span itemprop="author">{if $smartshowauthorstyle != 0}{$firstname} {$lastname}{else}{$lastname} {$firstname}{/if}</span>&nbsp;{/if}<i class="icon icon-calendar"></i>&nbsp;<span itemprop="dateCreated">{$created|date_format}</span>&nbsp;&nbsp;<i class="icon icon-tags"></i>&nbsp;<span itemprop="articleSection"><a href="{smartblog::GetSmartBlogLink('smartblog_category',$catOptions)}">{$title_category}</a></span> &nbsp;<i class="icon icon-comments"></i>&nbsp; {if $countcomment != ''}{$countcomment}{else}{l s='0' mod='smartblog'}{/if}{l s=' Comments' mod='smartblog'}</span>
